...
_sparks setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,12,1,1],"","Billboard",1,(3+random 7),[0,0,0],_velocityVector,1,0.0088,0.0038,0.08,[((random [0.8,1,1.2])*0.0001*(_size/2)),0],[[1,1,0.720384,-100],[0,0,0,0]],[1,0],3,1,"","","",0,false,0.21,[[45000,(random [25000,35000,45000]),(random [5000,10000,20000]),1000],[0,0,0,0]],[0,1,0]];
