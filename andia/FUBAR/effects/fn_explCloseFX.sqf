...
_sparks setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,12,1,1],"","Billboard",1,9,[0,0,0],_velocityVector,1,0.0058,0.0038,0.1,[((random [0.8,1,1.2])*0.0001*(_size/2)),0],[[1,1,0.720384,-100],[0,0,0,0]],[1,0],3,1,"","","",0,false,0.21,[[50000,30000,(random [10000,20000,25000]),1000],[0,0,0,0]],[0,1,0]];
