...
_sparks setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,12,1,1],"","Billboard",1,1.8,[0,0,0],_velocityVector,1,500,35,0.1,[(0.015*_randomSize),0],[[1,1,0.720384,-100],[0,0,0,0]],[1,0],3,1,"","","",0,false,0.31,[[500000,400000,(50000*_randomSize),10000],[0,0,0,0]],[0,1,0]];
_sparks setParticleRandom [1,[0,0,0],[(19*_randomSize),(19*_randomSize),(19*_randomSize)],3,1,[0,0,0,0],2,2,0,0];
